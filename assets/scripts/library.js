    ...
    $.each(books, function(index, book){
        const item = `<div class="grid-item">
                    ...
                    <div>
                         ...
                         <button class ="glow-on-hover" type="button" name="editBtn" id="editBtn" data-read-id="${book.bookId}">Edit</button> 
                         <button class ="glow-on-hover" type="button" name="deleteBtn" id="deleteBtn" data-read-id="${book.bookId}">Delete</button>     
                    </div>
                </div>`;
...
var gridBody = document.getElementById("myGrid");
